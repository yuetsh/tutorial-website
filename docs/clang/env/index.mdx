...
![mingw64-download](./mingw64-download.png)

下载好了之后是一个后缀名为 7z 的压缩包

![ming64zip](./mingw64-7z.png)
...
![env-settings](./env-settings1.png)

在弹出框中点击「环境变量」

![env-settings](./env-settings2.png)
...
![env-settings](./env-settings5.png)

新建一条系统环境变量，粘贴路径（记住是 bin 文件夹）

![env-settings](./env-settings4.png)
